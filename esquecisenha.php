<?php
  ...
  if(isset($_POST['enviar'])){
    $testeid = $codigo->RecuperarSenha();

    
    //echo "<script> alert('$testeid');</script>";
  }
?>
...
<style type="text/css">
  ...
  body { background-image: url(https://i.ytimg.com/vi/JlMNZntaoTY/maxresdefault.jpg);}
</style>
<nav class="topBar" >
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="text-center">
            ...
            <p>Digite seu email para recuperá-la.</p>
            
            <div class="panel-body">
    
              <form role="form" autocomplete="off" class="form" action="esquecisenha.php" method="POST">
    
                <div class="form-group">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-envelope color-blue"></i></span>
                    <input id="email" required="true" name="email" placeholder="exemplo@email.com.br" class="form-control"  type="email">
                  </div>
                </div>
                <div class="form-group">
